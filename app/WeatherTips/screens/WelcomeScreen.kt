...
fun WelcomeScreen(navController: NavController) {
    Surface(
        ...
        color = Color(0xFFEAF6FF) // Azul clarinho de fundo
    ) {
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            // Logo (substitua por seu recurso de imagem real depois)
            Icon(
                painter = painterResource(id = R.drawable.ic_weather), // coloque uma imagem em res/drawable
